...
public class Raytracer {
    public static void main(String[] args) {
        ...
        scene01.setCamera(new Camera(new Vector3D(0, 0, -4), 60, 60,
                800, 800, 0.6, 50.0));
        scene01.addLight(new DirectionalLight(new Vector3D(0.0, 1.0, 1.0), Color.WHITE, 1.1));
        ...
        scene01.addObject(new Model3D(new Vector3D(-1, -1, 3),
                ...
                Color.GREEN));
        scene01.addObject(OBJReader.getModel3D("W:\\-UP_PC-\\4th_SEMESTER\\MMCG_FOURTH_SEMESTER_RLG\\Raytracer\\LocalFiles\\ObjFiles\\SmallTeapot.obj", new Vector3D(0, -2.5, 1), Color.CYAN));
